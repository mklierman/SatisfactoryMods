	...
	SUBSCRIBE_METHOD(AFGHoverPack::ConnectToNearestPowerConnection, [](auto& scope, const AFGHoverPack* self)
		{
			...
			UKismetSystemLibrary::SphereOverlapComponents(self->GetWorld(), self->GetActorLocation(), self->mPowerConnectionSearchRadius, traceObjectTypes, CDOPCC->GetClass(), ignoreActors, outComps);
